...
const rules: LegalRule[] = [
  ...
  {
    id: "cr-cheat-001",
    title: "Cheating — Section 420, Penal Code 1860",
    rule: "Whoever cheats and thereby dishonestly induces the person deceived to deliver property, or to make/destroy a valuable security, shall be punished with imprisonment up to 7 years and fine.",
    source: "Penal Code 1860, Section 420",
    certainty: "confirmed",
  },
  {
    id: "cr-trust-001",
    title: "Criminal Breach of Trust — Sections 406-409, Penal Code 1860",
    rule: "Whoever, being entrusted with property, dishonestly misappropriates it or converts it to own use, is punished with imprisonment up to 3 years and fine. If entrusted as a public servant, banker, or agent: up to 10 years.",
    source: "Penal Code 1860, Sections 406-409",
    certainty: "confirmed",
  },
  {
    id: "cr-intimidation-001",
    title: "Criminal Intimidation — Sections 506-507, Penal Code 1860",
    rule: "Whoever threatens another with injury to person, reputation, or property to cause alarm, or to compel an act, shall be punished with imprisonment up to 2 years, fine, or both. If the threat is of death or grievous hurt: up to 7 years.",
    source: "Penal Code 1860, Sections 506-507",
    certainty: "confirmed",
  },
  {
    id: "cr-defamation-001",
    title: "Defamation — Sections 499-500, Penal Code 1860",
    rule: "Whoever makes or publishes an imputation harming another's reputation, intending or knowing it will harm, is guilty of defamation, punished with simple imprisonment up to 2 years, fine, or both.",
    source: "Penal Code 1860, Sections 499-500",
    certainty: "confirmed",
  },
...
const qaBank: QAEntry[] = [
  ...
  {
    id: "cr-qa-003",
    triggerKeywords: ["theft punishment", "stole my phone", "someone stole", "robbed my house", "theft case", "section 379", "stolen property"],
    question: "What is the punishment for theft in Bangladesh?",
    irac: {
      issue: "What punishment does Bangladesh law prescribe for theft?",
      rule: "Section 379 of the Penal Code 1860: Whoever commits theft shall be punished with imprisonment up to 3 years, or fine, or both.",
      application: "Theft requires dishonestly taking movable property out of another's possession without consent. If the stolen item is high-value or theft is by a servant/in a dwelling house, aggravated theft provisions (S.380/381) apply with higher penalties up to 7 years.",
      conclusion: "**Theft (S.379):** Up to 3 years imprisonment or fine or both.\n\nFile FIR immediately at the police station with jurisdiction where the theft occurred.\n\n📄 FIR drafting guide — ৳99",
    },
    escalate: false,
  ...
  {
    id: "cr-qa-004",
    triggerKeywords: ["robbery punishment", "robbed at gunpoint", "highway robbery", "section 392", "mugged"],
    question: "What is the punishment for robbery in Bangladesh?",
    irac: {
      issue: "What punishment does Bangladesh law prescribe for robbery?",
      rule: "Section 392 of the Penal Code 1860: Whoever commits robbery shall be punished with rigorous imprisonment up to 10 years and fine. If committed on a highway between sunset and sunrise, imprisonment may extend to 14 years.",
      application: "Robbery is theft or extortion committed with force or threat of instant harm. File FIR immediately; robbery is a cognizable, non-bailable offence — police can arrest without warrant.",
      conclusion: "**Robbery (S.392):** Up to 10 years rigorous imprisonment; up to 14 years if on highway at night.\n\n📄 Full procedure pack — ৳999",
    },
    escalate: true,
    escalateReason: "Robbery is a serious non-bailable offence. Immediate police report and legal counsel advised.",
    relatedRules: ["cr-robbery-001"],
  },
  {
    id: "cr-qa-005",
    triggerKeywords: ["dacoity punishment", "gang robbery", "5 people robbed", "section 395"],
    question: "What is the punishment for dacoity in Bangladesh?",
    irac: {
      issue: "What punishment does Bangladesh law prescribe for dacoity (robbery by 5 or more persons)?",
      rule: "Section 395 of the Penal Code 1860: Whoever commits dacoity shall be punished with imprisonment for life or rigorous imprisonment up to 10 years, and fine.",
      application: "Dacoity requires 5 or more persons jointly committing robbery. It is among the most serious property offences and is cognizable, non-bailable, triable by Sessions Court.",
      conclusion: "**Dacoity (S.395):** Life imprisonment or up to 10 years rigorous imprisonment + fine.\n\n📄 Full procedure guide — ৳999",
    },
    escalate: true,
    escalateReason: "Dacoity is a grave offence tried in Sessions Court. Engage a criminal advocate immediately.",
    relatedRules: ["cr-dacoity-001"],
  },
  {
    id: "cr-qa-006",
    triggerKeywords: ["grievous hurt punishment", "beaten badly", "broken bone assault", "section 325", "permanent injury assault"],
    question: "What is the punishment for grievous hurt in Bangladesh?",
    irac: {
      issue: "What punishment does Bangladesh law prescribe for causing grievous hurt?",
      rule: "Sections 320 and 325 of the Penal Code 1860: Whoever voluntarily causes grievous hurt shall be punished with imprisonment up to 7 years and fine. Grievous hurt includes permanent disfigurement, fracture, or injury endangering life.",
      application: "Grievous hurt is distinguished from simple hurt by severity — permanent damage, fracture, or life-threatening injury. Obtain a medical certificate immediately as it determines whether the injury qualifies as grievous.",
      conclusion: "**Grievous Hurt (S.325):** Up to 7 years imprisonment + fine.\n\nGet a medical legal certificate (MLC) from a government hospital before filing FIR.\n\n📄 Assault case guide — ৳999",
    },
    escalate: false,
  ...
  {
    id: "cr-qa-007",
    triggerKeywords: ["kidnapping punishment", "kidnapped", "child abducted", "section 363", "ransom kidnapping"],
    question: "What is the punishment for kidnapping in Bangladesh?",
    irac: {
      issue: "What punishment does Bangladesh law prescribe for kidnapping?",
      rule: "Section 363 of the Penal Code 1860: Whoever kidnaps any person shall be punished with imprisonment up to 7 years and fine. Kidnapping for ransom carries heavier punishment under special laws.",
      application: "Kidnapping includes taking a minor out of lawful guardianship without consent, or taking any person by force/deception out of Bangladesh. Kidnapping for ransom is treated far more seriously and may attract death penalty under special legislation.",
      conclusion: "**Kidnapping (S.363):** Up to 7 years + fine. Kidnapping for ransom: substantially higher penalty, up to death.\n\nReport to police immediately — kidnapping is cognizable, non-bailable.\n\n📄 Urgent reporting guide — ৳99",
    },
    escalate: true,
    escalateReason: "Kidnapping requires immediate police involvement. Contact NLC for urgent referral.",
    relatedRules: ["cr-kidnap-001"],
  },
  {
    id: "cr-qa-008",
    triggerKeywords: ["forgery punishment", "fake document case", "forged signature", "section 463", "forged deed criminal"],
    question: "What is the punishment for forgery in Bangladesh?",
    irac: {
      issue: "What punishment does Bangladesh law prescribe for forgery?",
      rule: "Sections 463-468 and 471 of the Penal Code 1860: Forgery of documents generally: up to 2 years. Forgery of court records/public registers: up to 7 years. Forgery for the purpose of cheating: up to 7 years. Using a forged document as genuine carries the same punishment as forgery itself.",
      application: "The severity depends on what was forged and its purpose — forging a will, deed, or valuable security to cheat someone attracts the higher 7-year band. File both a criminal complaint and consider parallel civil action if a forged deed affected property rights.",
      conclusion: "**Forgery (S.463-468):** Up to 2 years (general) or up to 7 years (court records, or forgery to cheat).\n\n📄 Forgery case guide — ৳999",
    },
    escalate: true,
    escalateReason: "Forgery cases often intersect with property or financial fraud and need coordinated civil/criminal strategy.",
    relatedRules: ["cr-forgery-001"],
  },
  {
    id: "cr-qa-009",
    triggerKeywords: ["cheating punishment", "someone cheated me money", "section 420", "fraud case bangladesh", "deceived into paying"],
    question: "What is the punishment for cheating (fraud) under Section 420?",
    irac: {
      issue: "What punishment does Bangladesh law prescribe for cheating?",
      rule: "Section 420 of the Penal Code 1860: Whoever cheats and thereby dishonestly induces delivery of property, or the making/destruction of a valuable security, shall be punished with imprisonment up to 7 years and fine.",
      application: "Cheating requires dishonest inducement — deceiving someone into handing over money or property, or signing/destroying a document of value. This is distinct from a genuine civil contract dispute; intent to deceive from the outset is key.",
      conclusion: "**Cheating (S.420):** Up to 7 years imprisonment + fine.\n\nGather all evidence of the deception (messages, payment records, false representations) before filing FIR.\n\n📄 Fraud case guide — ৳999",
    },
    escalate: false,
    relatedRules: ["cr-cheat-001"],
  },
  {
    id: "cr-qa-010",
    triggerKeywords: ["breach of trust punishment", "embezzlement", "misappropriated my money", "section 406", "employee stole company money"],
    question: "What is the punishment for criminal breach of trust in Bangladesh?",
    irac: {
      issue: "What punishment does Bangladesh law prescribe for criminal breach of trust?",
      rule: "Sections 406-409 of the Penal Code 1860: Whoever, being entrusted with property, dishonestly misappropriates or converts it to their own use, is punished with imprisonment up to 3 years and fine. If committed by a public servant, banker, or agent in that capacity: up to 10 years.",
      application: "This applies where property was legally entrusted (e.g., an employee handling company funds, an agent holding client money) and then dishonestly misused — distinguishing it from theft, where possession was never lawfully given.",
      conclusion: "**Criminal Breach of Trust (S.406-409):** Up to 3 years (general); up to 10 years (banker/agent/public servant).\n\n📄 Embezzlement case guide — ৳999",
    },
    escalate: true,
    escalateReason: "Breach of trust cases often involve financial records requiring forensic accounting support.",
    relatedRules: ["cr-trust-001"],
  },
  {
    id: "cr-qa-011",
    triggerKeywords: ["criminal intimidation", "threatened me", "someone threatened to kill", "section 506", "threat case bangladesh"],
    question: "What is the punishment for criminal intimidation (threats) in Bangladesh?",
    irac: {
      issue: "What punishment does Bangladesh law prescribe for criminal intimidation?",
      rule: "Sections 506-507 of the Penal Code 1860: Whoever threatens another with injury to person, reputation, or property to cause alarm or compel an act shall be punished with imprisonment up to 2 years, fine, or both. If the threat is of death or grievous hurt: up to 7 years.",
      application: "Save all evidence of the threat (messages, recordings, witnesses). Anonymous threats attract additional penalty under Section 507.",
      conclusion: "**Criminal Intimidation (S.506-507):** Up to 2 years (general); up to 7 years (threat of death/grievous hurt).\n\n📄 Threat/harassment case guide — ৳999",
    },
    escalate: false,
    relatedRules: ["cr-intimidation-001"],
  },
  {
    id: "cr-qa-012",
    triggerKeywords: ["defamation punishment", "someone defamed me", "section 499", "false accusation online", "damaged my reputation"],
    question: "What is the punishment for defamation in Bangladesh?",
    irac: {
      issue: "What punishment does Bangladesh law prescribe for defamation?",
      rule: "Sections 499-500 of the Penal Code 1860: Whoever makes or publishes an imputation harming another's reputation, knowing or intending it to cause harm, is guilty of defamation — punished with simple imprisonment up to 2 years, fine, or both.",
      application: "Defamation can be spoken (slander) or written/published (libel), including online posts. If the defamatory statement was published online, the Cyber Security Act 2023 may apply in parallel with higher penalties.",
      conclusion: "**Defamation (S.499-500):** Up to 2 years simple imprisonment + fine.\n\nIf published online, this may also fall under the Cyber Security Act 2023 — check that separately.\n\n📄 Defamation case guide — ৳999",
    },
    escalate: false,
    relatedRules: ["cr-defamation-001"],
  },
...

  {
    ...
    irac: {
      ...
      application: "If you are a victim or witness to a serious crime (theft, robbery, assault, fraud), you must go to the police station where the crime occurred. You do not need a lawyer to file an FIR. State the facts chronologicallyWho, What, When, Where, Why. The police cannot refuse to register an FIR for a cognizable offence.",
...

  {
    ...
    irac: {
      ...
      application: "You cannot get an FIR quashed at the police station or the Magistrate court if a charge sheet has already been filed. You must go directly to the High Court Division. The High Court will look at the FIR contentsif the allegations do not constitute an offence even if taken at face value, or if it is purely a civil dispute disguised as a criminal case, the Court will quash it.",
      conclusion: "**How to Quash a False FIR:**\n1. Engage a High Court advocate immediately\n2. File a Writ Petition under Art 102 + S.561A CrPC\n3. Provide evidence that the FIR is malicious, absurd, or a civil dispute\n4. If High Court is convinced, they will pass an order quashing the FIR, staying arrest\n\n Do not wait for trial to start. Quash early to avoid arrest and harassment.\n FIR Quash petition guide  1,999",
    },
    escalate: true,
