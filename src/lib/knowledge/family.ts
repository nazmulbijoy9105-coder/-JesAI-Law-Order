...
const rules: LegalRule[] = [
  {
    ...
    certainty: "confirmed",
    tags: ["talaq", "divorce", "notice", "90 days"],
  ...
  },
  {
    ...
    certainty: "confirmed",
    tags: ["khul", "khula", "wife divorce", "court divorce"],
    lastVerified: "2025-03-09",
  },
  {
    id: "fam-denmahr-001",
    ...
    certainty: "confirmed",
    tags: ["denmahr", "mahr", "mehr", "dowry", "kabin"],
    lastVerified: "2025-03-09",
  },
  {
    id: "fam-custody-001",
    ...
    certainty: "confirmed",
    tags: ["custody", "child", "guardianship", "hizanat"],
    lastVerified: "2025-03-09",
  },
  {
    ...
    certainty: "confirmed",
    tags: ["maintenance", "nafaqa", "alimony", "wife support"],
    lastVerified: "2025-03-09",
  },
  {
    id: "fam-hindu-001",
    ...
    certainty: "arguable",
    tags: ["hindu marriage", "hindu divorce", "separation"],
    lastVerified: "2025-03-09",
  },
  {
    id: "fam-dowry-001",
    ...
    certainty: "confirmed",
    tags: ["dowry", "joutuk", "dowry death", "harassment"],
    lastVerified: "2025-03-09",
  },
  {
    id: "fam-dv-001",
    ...
    certainty: "confirmed",
    tags: ["domestic violence", "abuse", "protection order"],
    lastVerified: "2025-03-09",
  },
];
...
const qaBank: QAEntry[] = [
  {
    ...
    area: "family",
    jurisdiction: "BD",
    triggerKeywords: ["talaq", "divorce", "muslim", "separation", "pronouncement", "তালাক", "বিচ্ছেদ"],
  ...
  },
  {
    ...
    area: "family",
    jurisdiction: "BD",
    triggerKeywords: ["khul", "khula", "wife divorce", "mutual", "woman divorce", "খুলা"],
  ...
  },
  {
    ...
    area: "family",
    jurisdiction: "BD",
    triggerKeywords: ["denmahr", "mahr", "mehr", "kabin", "kabinanama", "দেনমোহর", "মোহর"],
  ...
  },
  {
    ...
    area: "family",
    jurisdiction: "BD",
    triggerKeywords: ["maintenance", "nafaqa", "alimony", "wife support", "ভরণপোষণ"],
  ...
  },
  {
    ...
    area: "family",
    jurisdiction: "BD",
    triggerKeywords: ["custody", "child", "guardianship", "hizanat", "mother", "father", "হেফাজত"],
  ...
  },
  {
    ...
    area: "family",
    jurisdiction: "BD",
    triggerKeywords: ["polygamy", "second wife", "second marriage", "multiple wives", "বিবাহ"],
  ...
  },
  {
    ...
    area: "family",
    jurisdiction: "BD",
    triggerKeywords: ["hindu marriage", "hindu divorce", "সতী", "হিন্দু বিবাহ"],
  ...
  },
  {
    ...
    area: "family",
    jurisdiction: "BD",
    triggerKeywords: ["dowry", "joutuk", "dowry demand", "dowry death", "যৌতুক"],
  ...
  },
  {
    ...
    area: "family",
    jurisdiction: "BD",
    triggerKeywords: ["domestic violence", "abuse", "wife beating", "protection order", "গৃহ নির্যাতন"],
  ...
  },
  {
    ...
    area: "family",
    jurisdiction: "BD",
    triggerKeywords: ["child marriage", "age", "minor", "underage", "bal bibah", "বাল্যবিবাহ"],
