...
const qaBank: QAEntry[] = [
  ...
  },
  {
    ...
    irac: {
      ...
      application: "If your husband is not maintaining you, file a petition in Family Court. You do not need to wait for a final orderthe court can grant interim (temporary) maintenance immediately. The amount depends on husband's income and social status. If he fails to pay, the court can attach his salary or bank account.",
  ...
  },
  {
    ...
    irac: {
      ...
      application: "If you are facing dowry demands, document everything (messages, recordings). File a police report immediatelydelay weakens the case. You can simultaneously file under the Dowry Act and Domestic Violence Act 2010 for a protection order. Seek shelter at a One Stop Crisis Centre (OCC) if in physical danger.",
